...
export const Skills = () => {
  return (
    <section
      id="skills"
      className="py-25 pb-24  px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans bg-skills-gradient clip-path-custom"
    >
      {/* Heading Skill */}
      <div className="text-center mb-8">
        <h2 className="text-white text-3xl sm:text-4xl font-bold">SKILLS</h2>
        <div className="w-24 h-1 bg-[#8245ec] mx-auto mt-2"></div>
        <p className="text-2xl font-semibold  text-[#545158] mt-5 ">
                 ...
                 category.skills.map((skill) => (
                  <div key={skill.name}
                   className="flex items-center justify-center space-x-2 bg-transparent border-2 border-gray-700 rounded-3xl py-2 px-2 sm:py-2 sm:px-2 text-center">
                    <img src={skill.logo} alt={`{skill.name} logo`}  className="w-10 h-10 sm:w-8 sm:h-8" />
